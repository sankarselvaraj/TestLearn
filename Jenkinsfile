    ...
    stages {
        ...
        stage('Deploy') {
            steps {
                ...
                bat(/"C:\Users\sanka\Learn\terraform\terraform" apply -var-file=C:\Users\sanka\Learn\terraform\terraform.tfvars -state-out=C:\windows\System32\config\systemprofile\AppData\local\Jenkins.jenkins\workspace\TestGitPull_TestLearn_master\terraform.tfstate C:\Users\sanka\Learn\terraform\terraform1\terraform.tfstate/)
            }
        }
        stage('Verification') {
            steps {
